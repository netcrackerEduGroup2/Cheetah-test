...
public class LIbraryConsts {
    ...
    public static final String CREATE_LIBRARY =
            "INSERT INTO library (description, name , createdate) VALUES (?,?,?);";

    public static final String SELECT_ALL =
            "SELECT id, description, name , createdate FROM library;";

    public static final String FIND_LIBRARY_BY_ID =
            "SELECT id, description, name , createdate FROM library WHERE id = ?;";
    ...
    public static final String SELECT_LIBRARIES_BY_NAME =
            "SELECT id, description, name , createdate FROM library WHERE name LIKE CONCAT('%',?,'%');";
