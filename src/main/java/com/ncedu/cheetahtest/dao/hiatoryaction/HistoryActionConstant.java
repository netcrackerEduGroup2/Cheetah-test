...
public final class HistoryActionConstant {
    public static final String ADD_HISTORY_ACTION =
            "INSERT INTO action_result " +
                    "   (result, screenshot_url, general_order, id_history_test_case, compound_id, element, argument, id_action)" +
                    "   VALUES (?, ?, ?, ?, ?, ?, ?, ?);";

    public static final String ADD_HISTORY_ACTION_WITHOUT_COMPOUND =
            "INSERT INTO action_result " +
                    "   (result, screenshot_url, general_order, id_history_test_case, element, argument, id_action)" +
                    "   VALUES (?, ?, ?, ?, ?, ?, ?);";
