...
public class NotificationsDaoConsts {
    ...
    public static final String GET_PAGINATED_NOTIFICATIONS = "SELECT id, notification_status, date, test_case_id, project_id, read_status " +
            "FROM notifications WHERE user_id = ? ORDER BY read_status LIMIT ? OFFSET ?";
    public static final String FIND_BY_ID = "SELECT id, notification_status, date, test_case_id, project_id, read_status " +
