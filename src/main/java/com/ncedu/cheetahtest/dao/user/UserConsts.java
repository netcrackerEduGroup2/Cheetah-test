...
public class UserConsts {
    public static final String CREATE_USER_SQL = "INSERT INTO users (email, password, name, role, status) VALUES (?,?,?,?::user_role,?::user_status)";
    ...
    public static final String FIND_WATCHERS_BY_PROJECT_ID = "SELECT id, email, password, name, role, status, last_request, photo_url FROM users WHERE id IN (SELECT user_id FROM user_project WHERE project_id = ? AND user_status = 'WATCHER')";
