...
public final class ProjectSqlConsts {
    ...
    public static final String SELECT_PROJECT_BY_NAME_QUERY  = "SELECT id, name, link, status, create_date " +
                                                               "FROM project " +
                                                               "WHERE name = ?";
    ...
    public static final String SELECT_ALL_ARCHIEVED_PROJECTS_QUERY = "SELECT id, name, link, status, create_date " +
                                                                     "FROM project " +
    ...
    public static final String SELECT_PROJECT_BY_ID_QUERY = "SELECT id, name, link, status, create_date " +
                                                            "FROM project " +
                                                            "WHERE id = ?";


    public static final String SELECT_ORDERED_PROJECTS = "SELECT id, name, link, status, create_date " +
                                                         "FROM project " +
                                                         "ORDER BY ? DESC";
}
