...
public class CompoundConsts {
    ...
    public static final String SELECT_ALL =
            "SELECT id, title, description, idtestscenario, status FROM compounds;";

    public static final String SELECT_ACTIVE_COMPOUND_BY_TITLE =
            "SELECT compounds.id, compounds.title, compounds.description, compounds.idtestscenario, " +
    ...
    public static final String CREATE_COMPOUND =
            "INSERT INTO compounds (title,description,idtestscenario,status) " +
    ...
    public static final String FIND_COMPOUND_BY_ID =
            "SELECT id,title,description,idtestscenario,status " +
    ...
    public static final String EDIT_COMPOUND =
            "UPDATE compounds SET title = ?, description = ?, idtestscenario = ?, status = ?::compound_status " +
            "WHERE compounds.id = ?;";
    ...
    public static final String SET_TESTSCENARIO_ID =
            "UPDATE compounds SET idtestscenario = ? WHERE id = ?;";
